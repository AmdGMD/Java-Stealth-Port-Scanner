...
1. Compile the Code
Open your terminal or PowerShell in the project directory and run: javac PortScannerCLI.java

2. Run the Tool
To launch the interactive menu: java PortScannerCLI

To display the help menu: java PortScannerCLI --help
